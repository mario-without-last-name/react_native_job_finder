  ...
  return (
    <TouchableOpacity style={styles.container(selectedJob, item)} onPress={() => handleCardPress(item)}>
      <TouchableOpacity style={styles.logoContainer(selectedJob, item)}>
        <Image source={{uri: checkImageURL(item.employer_logo) ? item.employer_logo : "https://cdn-icons-png.flaticon.com/512/6956/6956765.png" }} resizeMode="cotain" style={styles.logoImage}/>
      </TouchableOpacity>
